  ...
  <section class="home-section-2">
        <div class="second-container">
          ...
          <div class="container-flex card1">
            ...
            <div 
              class="image"> <img src="<?php echo $my_image['url']; ?>" alt="">
            </div>
          </div>
          ...
          <div class="container-flex card2">
            ...
            <div 
              class="image"> <img src="<?php echo $my_image2['url']; ?>" alt="">
            </div>
          </div>
          ...
          <div class="container-flex card3">
            ...
            <div 
              class="image"> <img src="<?php echo $my_image3['url']; ?>" alt="">
            </div>
          </div>
          ...
          <div class="container-flex card4">
            ...
            <div 
              class="image"> <img src="<?php echo $my_image4['url']; ?>" alt="">
            </div>
          </div>
          ...
          <div class="container-flex card5">
            ...
            <div 
              class="image"> <img src="<?php echo $my_image5['url']; ?>" alt="">
            </div>
          </div>
        </div>
  </section>
